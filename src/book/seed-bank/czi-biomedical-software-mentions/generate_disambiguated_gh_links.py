...
"""Export disambiguated software mentions with GitHub repository links to Parquet.

Run with uv:
- `uv run src/book/seed-bank/czi-biomedical-software-mentions/generate_disambiguated_gh_links.py`
...
def parse_args() -> argparse.Namespace:
    ...
    default_data_dir = script_dir / "data" / "doi_10_5061_dryad_zgmsbccjk__v20241112"
    default_output = script_dir / "czi_software_mentions_disambiguated_gh_links.parquet"
